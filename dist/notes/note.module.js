...
exports.NoteModule = NoteModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [note_service_1.NoteService, note_repository_1.NoteRepository, note_gateway_1.NoteGateway],
        exports: [note_service_1.NoteService, note_repository_1.NoteRepository],
    })
], NoteModule);
