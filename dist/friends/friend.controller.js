...
let FriendController = class FriendController {
    ...
    async getFriendSuggestions(req) {
        const user = req.userInfo;
        const suggestions = await this.friendService.getFriendSuggestions(user.userId);
        return new api_response_1.ApiResponse(suggestions);
    }
    async getAllRelationshipsWithUser(req, targetUserId) {
        const user = req.userInfo;
        const relationships = await this.friendService.getAllRelationshipsWithUser(user.userId, targetUserId);
        return new api_response_1.ApiResponse(relationships);
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], FriendController.prototype, "getFriendSuggestions", null);
__decorate([
    (0, swagger_1.ApiParam)({
        name: 'userId',
        type: String,
    }),
    (0, common_1.Get)('relationships/:userId'),
    __param(0, (0, common_1.Request)()),
    __param(1, (0, common_1.Param)('userId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", Promise)
], FriendController.prototype, "getAllRelationshipsWithUser", null);
