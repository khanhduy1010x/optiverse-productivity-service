...
exports.NoteFolderModule = NoteFolderModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: note_folder_schema_1.NoteFolder.name, schema: note_folder_schema_1.NoteFolderSchema }]),
            note_module_1.NoteModule,
        ],
        controllers: [note_folder_controller_1.NoteFolderController],
        providers: [note_folder_service_1.NoteFolderService, note_folder_repository_1.NoteFolderRepository],
        exports: [note_folder_service_1.NoteFolderService],
    })
], NoteFolderModule);
