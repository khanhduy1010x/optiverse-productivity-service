...
exports.StreakModule = StreakModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: streak_schema_1.Streak.name, schema: streak_schema_1.StreakSchema }]),
        ],
        controllers: [streak_controller_1.StreakController],
        providers: [streak_service_1.StreakService, streak_repository_1.StreakRepository],
        exports: [streak_service_1.StreakService, streak_repository_1.StreakRepository],
    })
], StreakModule);
